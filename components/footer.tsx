          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-yellow-400/10 hover:bg-yellow-400/20 border border-yellow-400/20 text-yellow-300 px-3 py-1.5 rounded-lg text-sm transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <a href={link.href} className="text-gray-400 hover:text-yellow-300 transition-colors text-sm">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <a href="mailto:tubaferram@gmail.com" className="hover:text-yellow-300 transition-colors">
                  tubaferram@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-2 text-sm text-gray-400">
                <Phone className="h-4 w-4 text-yellow-300 flex-shrink-0" />
                <a href="https://wa.me/5511912854204" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-300 transition-colors">
                  (11) 91285-4204
                </a>
              </div>
